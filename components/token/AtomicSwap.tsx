...
export default function AtomicSwap() {
  ...
  const handleAtomicSwap = async () => {
    ...
    try {
      ...
      // Step 2: User signs their transaction
      const unsignedTxn = new Uint8Array(data.data.unsignedTransaction)
  ...
  const calculateDegenAmount = () => {
    ...
    return parseFloat(algoAmount) * 10000 // 1 ALGO = 10,000 DEGEN
  }
  ...
  return (
    <SwapCard>
      ...
      <div style={{ 
        ...
        🔄 Atomic Transaction - Instant & Safe!
      </div>
